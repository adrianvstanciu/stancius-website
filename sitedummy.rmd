...
![```Terminal``` with git version 2.29.2.](gitcodeterm.png)
...
![Add your SSH key.](sshkey.gif){ width=150%}
...
![Your repository on GitHub.](creategithubrepos.gif){ width=150%}
</center>
...
![Where is your personal link on GitHub.](yourgithublink.gif){ width=150%}
...
![Associate an Rproject with your repository.](associaterproj.gif){ width=150%}
</center>
...
![Find your icons.](faicons.gif){ width=150%}
...
![Kniting is amazing!](knitprev.gif){ width=150%}
...
2. Once in the right directory, you are going to command the computer to: 
  ...
  ![My current *commit*.](commit.png){ width=150%}
...
1. ![](whereismysite1.png){ width=200%}
...
2. ![](whereismysite2.png){ width=200%}
...
![Manage your DNZ specs.](customdns1.png){ width=200%}
