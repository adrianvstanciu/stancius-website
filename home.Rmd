...
[![](https://www.iaccp.org/wp-content/uploads/2019/10/iaccp-logo.jpg){ width=25% align="left" title="ORPC"}](https://scholarworks.gvsu.edu/orpc/)
...
[![](http://iwuensche.user.jacobs-university.de/wp-content/uploads/2015/09/Jacobs_University_Logo.jpg){ width=25% align="left" title="Jacobs Uni"}](https://www.jacobs-university.de/)
...
![Figure 1. Direct effects at level-1 for blatant (above) and subtle (below) ageism.](agesociety_fig2.jpg){title="Results of level-1 mediation models"}
...
[![](jspp.png){ width=50% align="left" title="Editorial board member JSPP"}](https://jspp.psychopen.eu/index.php/jspp/ed-board)
...
Building on the theoretical framework and concept introduced in Stanciu and Vauclair (2018), in [this](stanciuetal2019.pdf) paper we ([CM Vauclair](https://www.researchgate.net/profile/Melanie_Vauclair), [N Rodda](http://ehess.fr/), and myself) test the stereotype accommodation hypothesis in samples of Romanian immigrants in Germany and France. 
